...
| Effect modifier (interaction) | A variable that changes the *strength or slope* of a relationship | Species changes slope of length→depth (if slopes differ) |
...
| Moderator (plain synonym for effect modifier) | “Changes the effect size” | Sex modifies strength (if noticeable) |
