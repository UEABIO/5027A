...
In the previous exercise, you used R and the `lm()` function to perform a two-sample t-test. In this assignment, you’ll extend that work by conducting a **paired t-test** using the *Darwin plant height* dataset as an example:
...
- Paired connections (lines between pairs),
...
- How does the correlation between paired observations support your design?

- How do your visuals complement your numerical findings?
